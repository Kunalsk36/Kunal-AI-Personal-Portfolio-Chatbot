export default function TypingIndicator() {
  return (
    <div className="flex w-full justify-start animate-fade-in">
      <article className="max-w-[90%] rounded-2xl rounded-bl-sm px-5 py-3 shadow-sm border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text)] flex items-center gap-2">
